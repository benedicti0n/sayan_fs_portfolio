...
import Particles from '../components/WhiteParticles/Particles'; // Import Particles component
import Cloud from '../components/Cloud/Cloud'; // Import Cloud component
import Thunder from '../components/Thunder/Thunder'; // Import Thunder component
import styles from './Essence.module.css'; // Import scoped CSS
            ...
            <div className={styles.essenceContainer}>
                ...
                <section className={styles.essenceSection}>
                    <div className={styles.container}>
                        ...
                        <h2>Hi there,</h2>
                        <p>
                            I'm Sayan Banik, a tech enthusiast and problem solver, passionate about innovation, coding,
                            and building impactful digital solutions while continuously expanding my skills in React.js.
                        </p>
                        <ul>
                        ...
                        <strong>
                            <Link to="/craft" className={styles.exploreButton}>
                                Explore My Work
                            </Link>
                        </strong>
                    </div>
